...
## L'optimisation avec la fonction 'nlm', ci-dessus, a généré
## des avertissements? C'est parce que la fonction
## d'optimisation s'est égarée dans les valeurs négatives,
## alors que les paramètres d'une gamma sont strictement
## positifs. Cela arrive souvent en pratique et cela peut
## faire complètement dérailler la procédure d'optimisation
## (c'est-à-dire: pas de convergence).
##
