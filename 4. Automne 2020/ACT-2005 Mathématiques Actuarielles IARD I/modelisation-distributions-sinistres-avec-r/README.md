...
*Modélisation des distributions de sinistres avec R* est un ouvrage de référence traitant de modélisation statistique des montants de sinistres en assurance de dommages. Il regroupe les notes, les exercices et le code R utilisés par l'auteur dans le cadre du cours Mathématiques actuarielles IARD~I offert à l'[École d'actuariat](https://www.act.ulaval.ca) de l'[Université Laval](https://www.ulaval.ca).
...
Ensuite, des connaissances de base sur le fonctionnement de LaTeX sont nécessaires. Consultez [*Rédaction avec LaTeX*](https://vigou3.github.io/formation-latex-ul/), la formation LaTeX de l'Université Laval. 
...
- [Font Awesome](https://fontawesome.com/). Cette police fournit une multitude d'icônes et de symboles. Téléchargez la [version 4.7.0](https://fontawesome.com/4.7.0 ) de la distribution et installez la police `fontawesome-webfont.ttf` du dossier `fonts`.
